<form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" id="registrationDate" value="<?php echo date('Y-m-d');?>"readonly>
                            </div>
                    ...
                    <div class="row">
                            <div class="col d-grid">
                                <button type="submit" class="btn btn-primary"id="add_staff">Thêm</button>
                            </div>
                        </div>

<script>
    document.getElementById('add_staff').addEventListener('click', (e) => {
    e.preventDefault();
    ...
    if (fullname === '' || username === '' || password === '' || email === '' || address === '' || status === '' || !file || phone === '') {
        ...
        xhr.open('POST', './Controller/Add_StaffController.php', true);
        xhr.onload = () => {
            if (xhr.status === 200) {
                let response;
                try {
